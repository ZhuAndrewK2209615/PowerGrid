...
- Copy and paste this command into the git bash terminal: "git clone https://github.com/ZhuAndrewK2209615/PowerGrid.git"
- All existing files will be cloned onto your local device, allowing you to make changes to them within the editor

➡️Pushing Changes to Github
...
- Type "git pull origin [branch-name]". In the [branch-name] parameter, type the name of the branch you're trying to pull changes from
- Your local files will be updated to the ones in GitHub

🔀Switching branches
- To switch to an existing branch, type "git switch [branch-name]"
- To create a new branch based off of the currently existing one, type "git checkout -b [new-branch-name]"

Note: If any errors ever arise while using git bash, it is not a bad idea to create a new folder and re-clone the repository.